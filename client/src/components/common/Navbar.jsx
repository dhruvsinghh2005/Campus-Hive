...
import { FiHome, FiCalendar, FiClipboard, FiBell, FiAward, FiMessageSquare, FiLogOut, FiMenu, FiX, FiSettings } from "react-icons/fi";
      ...
      <nav className="flex flex-col gap-2 flex-1">
        {navLinks.map((link, i) => (
          ...
          >
            ...
            >
              <span className={`text-base ${isActive(link.path) ? "animate-glow-pulse text-indigo-500" : ""}`}>
                {link.icon}
              </span>
              {link.label}
            </Link>
